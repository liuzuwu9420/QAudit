    ...
    <div class="head">
      ...
      <el-form ref="queryForm" :model="queryParams" :inline="true" label-width="auto">
        ...
        <el-form-item label="状态" prop="handleStarus">
          ...
          >
            <el-option
              v-for="state in queryParams.statusOptions"
              :key="state.value"
              :label="state.label"
              :value="state.value"
            />
      ...
      <div class="head-buttons" style="margin-top: 5px">
        ...
        <el-button v-if="peopleRole !== '4' && peopleRole !== '8'" type="success" icon="el-icon-time" size="mini" :disabled="single">延期申请</el-button>
        <el-button v-if="status === 'reviewing' && peopleRole !== '4' && peopleRole !== '8'" type="primary" icon="el-icon-s-promotion" size="mini" :disabled="single" @click="submitEvidence()">提交纠正措施</el-button>
        <el-button v-if="status === 'Feedbacking' && peopleRole !== '4' && peopleRole !== '8'" type="primary" icon="el-icon-s-promotion" size="mini" :disabled="single" @click="submitEvidence()">提交措施完成证据</el-button>
...
export default {
  ...
  methods: {
    ...
    handleSelectionChange(selection) {
      ...
      this.status = selection.length === 1 ? selection[0].handleStarus : ''
